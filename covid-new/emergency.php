...
<center><p class="font-weight-normal">Fill in the following details.</p></center>
...
<div class="input-group">
  ...
  <input type="text" aria-label="mname" class="form-control">
</div>
...
<div class="input-group">
  ...
  <input type="text" aria-label="Pcode" class="form-control">
</div>
</td></tr>
...
<div class="input-group">
  ...
  <input type="text" aria-label="ecity" class="form-control">
</div>
</td></tr>
...
<button type="submit" class="btn btn-success" value="submit"> Submit </button>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script></td></tr>
...
<?php
if (isset($_POST['mname']) and isset($_POST['Pcode']) and isset($_POST['ecity']) and isset($_POST['ecountry'])){
...
$q ="INSERT INTO `euser`(`eno`,`epin`,`ecity`,`ecountry`) VALUES ('$mname','$pcode','$ecity','$ecountry')";
